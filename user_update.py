...
class Ui_User_Update(object):
    def setupUi(self, Form):
        ...
        self.label.setStyleSheet("QLabel{\n"
                                 ...
                                 "     border-style: solid;\n"
                                 "}")
        self.label.setPixmap((QtGui.QPixmap("./asserts/image/user_update.png")))
        ...
        self.pUserName.setPlaceholderText("输入用户名")
        ...
        self.pushButton.clicked.connect(Form.user_update_password)

        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "用户改密窗口"))
        self.pushButton.setText(_translate("Form", "USER更改密码"))
