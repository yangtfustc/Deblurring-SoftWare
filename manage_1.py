...
from models.model import DEBLUR

def parse_args():
    parser = argparse.ArgumentParser(description='deblur arguments')
    parser.add_argument('--phase', type=str, default='test', help='determine whether train or test')
    parser.add_argument('--datalist', type=str, default='./datalist_Hirsch.txt', help='training datalist')
    ...
    parser.add_argument('--input_path', type=str, default='E:\\Deblur_DataSet\\GOPRO_Large\\test\\GOPR0881_11_01\\blur',
                        help='input path for training images')
    parser.add_argument('--output_path', type=str, default='E:/PyQt5/Openimg/res/',
                        help='output path for training images')
    args = parser.parse_args()
    return args

def manage(input_path):
    args = parse_args()
    ...
    deblur = DEBLUR(args)
    if args.phase == 'test':
        deblur.test(args.height, args.width, input_path, args.output_path)
