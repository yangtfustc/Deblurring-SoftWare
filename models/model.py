...
class DEBLUR(object):
    ...
    def test(self, height, width, input_path, output_path):
        ...
        imgName = input_path [input_path.rfind(end):]
        print(imgName)
        H, W = height, width
        ...
        blur = scipy.misc.imread(input_path)
        h, w, c = blur.shape
        ...
        ## TODO:
        self.sumtime = self.sumtime + duration
        print('Saving results: %s ... %4.3fs' % (os.path.join(output_path, imgName), self.sumtime))
        ...
        # scipy.misc.imsave(output_path, res)
