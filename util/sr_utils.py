...
def load_LR_HR_imgs_sr(fname, imsize, factor, enforse_div32=None): # imsize = -1
...
def load_imgs_deblur(fname, imsize, enforse_div32=None):
    '''Loads an image, resizes it, center crops and downscales.
